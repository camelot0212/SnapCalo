...
import { calculateTDEE, saveUserProfile } from '../services/storage';
               ...
               <div className="space-y-4">
                  {[
                    ...
                    <button 
                      ...
                      className={`w-full p-5 rounded-3xl border-2 transition-all duration-200 text-left flex items-center gap-4 group ${
